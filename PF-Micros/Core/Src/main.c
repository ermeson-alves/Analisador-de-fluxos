...
/**
  ******************************************************************************
  * @file           : main.c
  * @brief          : Este projeto corresponde ao projeto final da cadeira
  * de sistemas microprocessados, feito por Ermeson Alves, Luis Carlos,
  * Carlos Victor e Guilherme Noronha
  ******************************************************************************
  * @attention
  *
